    ...
    <div className="space-y-2 rounded border p-3">
      ...
      <CdfLineAssign
        ...
        onAssign={async (section) => {
          const { id } = await assignNextCdfPage2Line(orderId, section, endorsement.description, endorsement.charge)
  ...
  return (
    <div className="space-y-3 rounded border p-4" data-testid={`premium-${premium.id}`}>
      ...
      <CdfLineAssign
        ...
        cdfLines={cdfLines}
        onAssign={async (section) => {
          const { id } = await assignNextCdfPage2Line(
            orderId,
            section,
            `${premium.policy_type ?? 'Policy'} Premium`,
